...
// Artigo de teste seguro para o Slug 'test-article'
const mockTestArticle: NexoraArticle = {
  ...
  canonicalUrl: "https://futuroagora.tech/articles/test-article"
};
...
export async function getNexoraArticleBySlug(slug: string): Promise<NexoraArticle | null> {
  ...
  // Entrega o mock apenas para o slug de testes se o endpoint for inexistente
